...
public final class VisualManager
{
    ...
    /*public ArrayList<ThinLocation> getCornerLocations(ThinLocation zLesserCorner, ThinLocation zGreaterCorner, ThinLocation cLesserCorner, ThinLocation cGreaterCorner)
    {
        ArrayList<ThinLocation> corners = new ArrayList<>();

        boolean isFullSizeZone = (zLesserCorner.getBlockY() == 1 && zGreaterCorner.getBlockY() == 255);

        // front left
        if (zLesserCorner.getBlockX() >= cLesserCorner.getBlockX() && zLesserCorner.getBlockZ() >= cLesserCorner.getBlockZ())
        {
            int x = zLesserCorner.getBlockX();
            int y = zLesserCorner.getBlockY();
            int z = zLesserCorner.getBlockZ();

            corners.add((isFullSizeZone)
                    ? this.getVisibleLocation(new ThinLocation(x, y, z))
                    : new ThinLocation(x, y, z));
        }

        // front right
        if (zGreaterCorner.getBlockX() <= cGreaterCorner.getBlockX() && zLesserCorner.getBlockZ() >= cLesserCorner.getBlockZ())
        {
            int x = zGreaterCorner.getBlockX();
            int y = zLesserCorner.getBlockY();
            int z = zLesserCorner.getBlockZ();
        ...
        // back left
        if (zLesserCorner.getBlockX() >= cLesserCorner.getBlockX() && zGreaterCorner.getBlockZ() <= cGreaterCorner.getBlockZ())
        {
            int x = zLesserCorner.getBlockX();
            int y = zLesserCorner.getBlockY();
            int z = zGreaterCorner.getBlockZ();
        ...
        // back right
        if (zGreaterCorner.getBlockX() <= cGreaterCorner.getBlockX() && zGreaterCorner.getBlockZ() <= cGreaterCorner.getBlockZ())
        {
            int x = zGreaterCorner.getBlockX();
            int y = zLesserCorner.getBlockY();
            int z = zGreaterCorner.getBlockZ();
        ...
        if (!isFullSizeZone)
        {
            ...
            {
                int x = zLesserCorner.getBlockX();
                int y = zGreaterCorner.getBlockY();
                int z = zLesserCorner.getBlockZ();
